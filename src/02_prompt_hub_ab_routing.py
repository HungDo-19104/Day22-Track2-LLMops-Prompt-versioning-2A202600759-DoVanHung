...
SYSTEM_V1 = (
    ...
    "Keep your answer concise and clear (2-4 sentences).\n"
...
SYSTEM_V2 = (
    "You are an expert AI analyst. Carefully read the context, identify relevant facts, "
    "and provide a well-structured, comprehensive answer (3-5 sentences).\n"
    "First summarize the key point, then elaborate with supporting details from the context.\n"
    "State your confidence level if the context is incomplete.\n"
